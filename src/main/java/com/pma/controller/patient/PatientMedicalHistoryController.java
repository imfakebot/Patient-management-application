...
public class PatientMedicalHistoryController {
    ...
    public void initialize() {
        ...
        recordDateColumn.setCellFactory(_ -> new TableCell<MedicalRecord, LocalDate>() {
            @Override
        ...
        medicalRecordsTable.getSelectionModel().selectedItemProperty().addListener((_, _, newSelection) -> {
