...
public interface AppointmentRepository extends JpaRepository<Appointment, UUID> {
     ...
     * @return Danh sách các Appointment phù hợp.
     */
    List<Appointment> findByPatient_PatientIdAndAppointmentDatetimeBetween(UUID patientId, LocalDateTime startDateTime,
    ...
    /**
     * Tìm các cuộc hẹn của một bệnh nhân, sắp xếp theo thời gian hẹn giảm dần, có
     * phân trang.
     * 
     * @param patientId ID của Patient.
    ...
    // --- Ví dụ sử dụng @Query ---
    /**
     * Tìm các cuộc hẹn chưa hoàn thành (Scheduled) của một bác sĩ trước một thời
     * điểm cụ thể.
     * 
     * @param doctorId   ID của Doctor.
